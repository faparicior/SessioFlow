 ...
 */
export function withApiCorrelation<TReq extends { headers: Headers }, TRes extends { headers: Headers }>(
  handler: ApiRouteHandler<TReq, TRes>
): ApiRouteHandler<TReq, TRes> {
