...
| :--- | :--- | :--- |
| [Activity Name] | • [Story A]<br>• [Story B] | [e.g., Critical for legal compliance] |
| [Activity Name] | • [Story C] | [e.g., Necessary for user to finish flow] |
| [Activity Name] | • [Story D] | [e.g., Differentiator for this release] |
...
### Slice 2: [e.g., "The Better/Enhanced Version"]

- **Goal:** [e.g., "Improve retention by adding social features"]
- **Key Stories:**
  - [Story Name]
  - [Story Name]

### Slice 3: [e.g., "The Best/Full Scale Version"]

- **Goal:** [e.g., "Scale to enterprise users"]
- **Key Stories:**
  - [Story Name]
  - [Story Name]
...
- **Discarded/Deferred:**
  - [Story Name] - **Reason:** High effort, low value.
  - [Story Name] - **Reason:** Solves a problem users don't care about yet.
