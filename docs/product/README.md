...
| [Inception Step 6: User Journey Mapping](../inception/5-user-journeys/) | User journeys (Journey 1-5) |
| [Inception Step 7: Features & Sequencing](../inception/7-features-and-sequencing.md) | Feature waves (MVP, Wave 2, Wave 3) |
| [Create Flow Command](../../.agents/skills/sessioflow-sdlc/create-flow-documentation/SKILL.md) | Prompt for generating flow docs |
| [Create Entity Lifecycle Command](../../.agents/skills/sessioflow-sdlc/create-entity-lifecycle/SKILL.md) | Prompt for generating entity docs |
