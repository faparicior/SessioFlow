...
> **Rule:** When creating an event, then the event name must be between 3-100 characters and contain valid characters, otherwise reject the operation with a validation error.
...
Scenario: Valid event name
  Given the organizer enters event name "Tech Conference 2026"
