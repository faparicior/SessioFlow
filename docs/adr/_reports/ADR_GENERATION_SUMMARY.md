...
### ✅ Architecture Patterns: 3 ADRs
- **ADR-006**: Use RESTful API Design
- **ADR-007**: Use Zod for Validation
- **ADR-017**: Use Drizzle ORM with Transaction Support

### ✅ Application Architecture: 2 ADRs
- **ADR-015**: Adopt CQRS Pattern for Application Layer
- **ADR-016**: Dependency Injection Strategy for Next.js
...
**ADR-017: Drizzle ORM**
- Addresses: Data persistence with DDD compatibility and transaction support
- Trade-off: Learning curve for SQL-like syntax
- Cost Impact: Zero cost, lightweight (~50KB)
...
| 015 | Adopt CQRS Pattern for Application Layer | Proposed | 2026-06-29 | Application Architecture |
| 016 | Dependency Injection Strategy for Next.js | Proposed | 2026-07-01 | Application Architecture |
| 017 | Use Drizzle ORM with Transaction Support at Application Layer | Proposed | 2026-07-01 | Data Access & Persistence |
...
**Total ADRs:** 17 (including amendments and analyses)
