...
| **6** | User Journey Mapping | `docs/templates/inception/6-user-journey-mapping.md` | `docs/inception/6-user-journeys/` | `docs/commands/inception/6-user-journey-validator.md` |
