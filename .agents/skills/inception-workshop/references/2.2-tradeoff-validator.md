...
Instructions for the Audit: Analyze the provided Trade-off Board data (likely in a table or list format) against these seven criteria:
...
7. Consensus Reasoning & Completeness

    The template includes a specific section for documenting the "Why".
    
    - Verification: Check if "Section 3. Consensus Reasoning" is present and filled out.
    - Verification: Ensure there is a specific explanation for why the #1 priority was chosen and why the lowest priority was sacrificed.
    - Verification: Check that the Product Name and other header details are completed.
...
Eval the file `docs/inception/2-tradeoffs.md` content and provide a compliance score for each section.
